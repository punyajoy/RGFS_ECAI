...
from transformers.models.roberta.modeling_roberta import RobertaForTokenClassification, RobertaForSequenceClassification, RobertaPreTrainedModel, RobertaModel 
...
class Model_Rational_Label(RobertaPreTrainedModel):
     def __init__(self,config,params):
