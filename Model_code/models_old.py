...
#         return model_type
    ...
    def tokenize(self, sentences, padding = True, max_len = 128):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained('bert-base-uncased', use_fast = False, cache_dir=self.cache_path,local_files_only=True)
...
class Transform_Rationale_CrossAttn_CLS_2Softmax_Drpt(BertPreTrainedModel):
    def __init__(self, config, params):
        ...
        self.num_heads = 12
        # dropout values
        # Transform_Rationale_CrossAttn_CLS_2Softmax_Drpt (untrained on HX):
        # 0.1 = 
        # Best Macro F1 Train = 0.8696
        # Best Macro-F1 Val = 0.7590
        # Best Macro-F1 Test = 0.7704
        # 0.2 = 
        # Best Macro-F1 Train = 0.8568
        # Best Macro-F1 Val = 0.7634
        # Best Macro-F1 Test = 0.7749
        # 0.3
        # Best Macro F1 Train = 0.8921
        # Best Macro-F1 Val = 0.7477
        # Best Macro-F1 Test = 0.7443
        # 0.4 = 
        # Best Macro-F1 Train = 0.9145
        # Best Macro-F1 Val = 0.7489
        # Best Macro-F1 Test = 0.7545
        self.dropout = nn.Dropout(0.2) # ADDED DROPOUT
